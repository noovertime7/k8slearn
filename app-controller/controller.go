...
func NewController(
	...
	ingressInformer v13.IngressInformer,
...
func (c *Controller) syncHandler(key string) error {
	...
	if errors.IsNotFound(err) {
		//创建ingress
		ingress, err = c.kubeclientset.NetworkingV1().Ingresses(App.Namespace).Create(context.TODO(), newSIngress(App), metav1.CreateOptions{})
	}
	if err != nil {
		return err
	}
...
func newSIngress(App *appv1alpha1.App) *v15.Ingress {
